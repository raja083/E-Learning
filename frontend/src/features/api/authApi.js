...
const USER_API = "https://e-learning-kgkm.onrender.com/api/user";
export const authApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    registerUser: builder.mutation({
      //query is used to fetch data while mutation is used to post data.
      query: (inputData) => ({
    ...
    loadUser: builder.query({
      //query is used to fetch (get) data while mutation is used to post data.
      query: () => ({
    ...
    logOutuser: builder.mutation({
      //logout is mutation because we are updating the state
      query: () => ({
        url: "/logout",
        method: "GET",
      }),
