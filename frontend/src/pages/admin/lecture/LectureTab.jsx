...
const LectureTab = () => {
  ...
  const [removeLecture, {isSuccess : removeIsSuccess, error: removeError, data:removeData, isLoading:removeLoading}] = useRemoveLectureMutation();
  const {getLectureById, isSuccess: lectureSuccess, data:lectureData, error:lectureError}=useGetLectureByIdQuery(params.lectureId);
  ...
  const fileChangeHandler = async (e) =>{
    ...
    if(file){
      ...
      try {
        const res = await axios.post(`${MEDIA_API}/upload-video`, formData,{//to show how much percent uploaded
  ...
  const editLectureHandler = async () =>{
    await editLecture({lectureTitle:title, videoInfo: uploadVideoInfo, courseId:params.courseId, lectureId: params.lectureId, isPreviewFree:isFree} )
  }
